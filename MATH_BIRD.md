...
- **20 Level Petualangan Progresif**: Mencakup operasi penjumlahan (+), pengurangan (-), perkalian (×), hingga pembagian (÷).
- **Mode Duel (2 Pemain / Lawan AI Bot)**: Arena kompetisi berhitung cepat untuk melatih kecepatan berpikir.
- **Mode Tanpa Henti (Endless)**: Uji ketahanan refleks dan kalkulasi angka tanpa batas.
- **Efek Audio & Visual Halus**: Efek partikel, animasi koin, nyawa, dan suara kemenangan yang menyenangkan.
...
4. **Mendorong Semangat Sportivitas**: Melalui mode duel, pemain dapat belajar berkompetisi secara sehat dan positif.
